...
include "../../../inc/koneksi.php";
$query    = mysqli_query($koneksi, "SELECT * FROM tb_baru WHERE id_baru='$id_berkas'");
...
<head>
    <title>TANDA TERIMA DAFTAR BARU</title>
...
<body>
    <center>
        ...
        <table>
            <strong style="font-size: 20px;"><b><u>TANDA TERIMA LAPORAN BARU</u></b></strong>
