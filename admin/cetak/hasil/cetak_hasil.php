  ...
  <div class="card card-dark">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <div>
          <a href="?page=data-hasil" class="btn btn-primary">
            <i class="fas fa-long-arrow-alt-left"></i> Menu Data Berkas Hasil Penyelidikan</a>
          <a href="admin\cetak\hasil\cetak_lap_hasil.php" target="_blank" title="Cetak" class="btn btn-success"><i class="fa fa-print"></i> Cetak Laporan</a>
        </div>
