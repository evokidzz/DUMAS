...
$pdf->Text(100, 42, 'LAPORAN DATA BERKAS PENCABUTAN LAPORAN');
...
$pdf->CELL(38, 6, 'KEPUTUSAN', 1, 0, 'C', 1);
...
while ($data = mysqli_fetch_array($sql)) {
    ...
    $pdf->setFont('Times', '', 5);
    $pdf->CELL(50, 6, $data['uraian'], 1, 0, 'C', 1);
    $pdf->setFont('Times', '', 8);
    $pdf->CELL(38, 6, $data['ket'], 1, 0, 'C', 1);
...
$pdf->AliasNbPages();
ob_clean();
$pdf->Output('I', 'Laporan Data Pencabutan Berkas.PDF');
}