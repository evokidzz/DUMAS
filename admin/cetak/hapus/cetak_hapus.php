  ...
  <div class="card card-dark">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <div>
          <a href="?page=data-hapus" class="btn btn-primary">
            <i class="fas fa-long-arrow-alt-left"></i> Menu Data Berkas Pencabutan Laporan</a>
          <a href="admin\cetak\hapus\cetak_lap_hapus.php" target="_blank" title="Cetak" class="btn btn-success"><i class="fa fa-print"></i> Cetak Laporan</a>
        </div>
