  ...
  <div class="card card-dark">
    ...
    <div class="card-body">
      <div class="table-responsive">
        <div>
          <a href="?page=add-dumas" class="btn btn-primary">
            ...
            ?>
              ...
              <tr>
                ...
                <td class="text-center">
                  ...
                  <a href="?page=del-dumas&kode=<?php echo $data['id_dumas']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')" title="Hapus" class="btn btn-danger btn-sm">
                    <i class="fa fa-trash"></i> </a>
                  <a href="admin\cetak\dumas\cetak_con_dumas.php?id_berkas=<?= $data['id_dumas'] ?>" target="_blank" title="Cetak" class="btn btn-success btn-sm">
